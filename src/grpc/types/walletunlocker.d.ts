...
import type {
  WalletUnlockerClient as _lnrpc_WalletUnlockerClient,
  WalletUnlockerDefinition as _lnrpc_WalletUnlockerDefinition,
} from './lnrpc/WalletUnlocker'
declare type SubtypeConstructor<
...
export interface ProtoGrpcType {
  lnrpc: {
    ...
    WalletUnlocker: SubtypeConstructor<
      typeof grpc.Client,
      _lnrpc_WalletUnlockerClient
    > & {
      service: _lnrpc_WalletUnlockerDefinition
    }
