...
import type { WitnessType as _walletrpc_WitnessType } from '../walletrpc/WitnessType'
import type { Long } from '@grpc/proto-loader'
export interface PendingSweep {
  outpoint?: _lnrpc_OutPoint | null
  witness_type?: _walletrpc_WitnessType | keyof typeof _walletrpc_WitnessType
  amount_sat?: number
  sat_per_byte?: number
...
export interface PendingSweep__Output {
  ...
  witness_type: keyof typeof _walletrpc_WitnessType
  amount_sat: number
  sat_per_byte: number
  broadcast_attempts: number
  next_broadcast_height: number
