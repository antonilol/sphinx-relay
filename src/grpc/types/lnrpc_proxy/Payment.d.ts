...
export declare enum _lnrpc_proxy_Payment_PaymentStatus {
  UNKNOWN = 0,
  IN_FLIGHT = 1,
  SUCCEEDED = 2,
  FAILED = 3,
...
export interface Payment {
  ...
  status?:
    ...
    | keyof typeof _lnrpc_proxy_Payment_PaymentStatus
  ...
  failure_reason?:
    | _lnrpc_proxy_PaymentFailureReason
    | keyof typeof _lnrpc_proxy_PaymentFailureReason
}
