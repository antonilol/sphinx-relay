...
import type { FeatureBit as _lnrpc_proxy_FeatureBit } from '../lnrpc_proxy/FeatureBit'
import type {
...
export interface SendRequest {
  ...
  dest_features?: (
    | _lnrpc_proxy_FeatureBit
    | keyof typeof _lnrpc_proxy_FeatureBit
  )[]
...
export interface SendRequest__Output {
  ...
  allow_self_payment: boolean
  dest_features: (keyof typeof _lnrpc_proxy_FeatureBit)[]
