...
export declare enum _lnrpc_proxy_Invoice_InvoiceState {
  OPEN = 0,
  SETTLED = 1,
  CANCELED = 2,
  ACCEPTED = 3,
...
export interface Invoice {
  ...
  state?:
    | _lnrpc_proxy_Invoice_InvoiceState
    | keyof typeof _lnrpc_proxy_Invoice_InvoiceState
  htlcs?: _lnrpc_proxy_InvoiceHTLC[]
  value_msat?: number | string | Long
  features?: {
    [key: number]: _lnrpc_proxy_Feature
  }
  is_keysend?: boolean
...
export interface Invoice__Output {
  ...
  state: keyof typeof _lnrpc_proxy_Invoice_InvoiceState
  htlcs: _lnrpc_proxy_InvoiceHTLC__Output[]
  value_msat: string
  features: {
    [key: number]: _lnrpc_proxy_Feature__Output
  }
  is_keysend: boolean
  payment_addr: Buffer
}
