...
import type { SignMethod as _signrpc_SignMethod } from '../signrpc/SignMethod'
export interface SignDescriptor {
  ...
  sighash?: number
  input_index?: number
  sign_method?: _signrpc_SignMethod | keyof typeof _signrpc_SignMethod
...
export interface SignDescriptor__Output {
  ...
  sighash: number
  input_index: number
  sign_method: keyof typeof _signrpc_SignMethod
  tap_tweak: Buffer
}
