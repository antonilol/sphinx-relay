...
export interface Payment {
  ...
  failure_reason?:
    | _lnrpc_PaymentFailureReason
    | keyof typeof _lnrpc_PaymentFailureReason
}
export interface Payment__Output {
  ...
  value_msat: string
  payment_request: string
  status: keyof typeof _lnrpc_Payment_PaymentStatus
  fee_sat: string
  fee_msat: string
  creation_time_ns: string
  htlcs: _lnrpc_HTLCAttempt__Output[]
  payment_index: string
  failure_reason: keyof typeof _lnrpc_PaymentFailureReason
}
