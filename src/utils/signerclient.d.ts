...
export class SignerClient {
  ...
  public signMessage(options: Options, callback: (err: Error, sig: Sig) => void): void
  public verifyMessage(options: Options, callback: (err: Error, res: unknown) => void): void // TODO what type
}
