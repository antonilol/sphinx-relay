...
function getContacts(t, node1, node2) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const n1contactP1 = res.response.contacts.find((contact) => contact.public_key === node1.pubkey);
        t.true(typeof n1contactP1 === 'object');
        if (node2) {
            // node2 contact object from node1 perspective
            const n2contactP1 = res.response.contacts.find((contact) => contact.public_key === node2.pubkey);
