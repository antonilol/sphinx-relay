...
function paidMeet(t, node1, node2) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const change = yield (0, save_1.updateProfile)(t, node1, meetPrice);
        ...
        yield (0, msg_1.sendMessageAndCheckDecryption)(t, node2, node1, text);
        //GET CONTACTS FROM NODE1, NODE2 WILL NOT BE LISTED
        const contacts = yield http.get(node1.external_ip + '/contacts', (0, helpers_1.makeArgs)(node1));
        ...
        const contacts2 = yield http.get(node1.external_ip + '/contacts?unmet=include', (0, helpers_1.makeArgs)(node1));
        ...
        const amount = 13;
        yield (0, msg_1.sendMessageAndCheckDecryption)(t, node2, node1, text2, { amount });
        //GET CONTACTS FROM NODE1, NODE2 WILL BE LISTED
        const contacts3 = yield http.get(node1.external_ip + '/contacts', (0, helpers_1.makeArgs)(node1));
        ...
        const amount2 = 13;
        yield (0, msg_1.sendMessageAndCheckDecryption)(t, node2, node1, text3, {
            amount: amount2,
        });
        //GET CONTACTS FROM NODE1, NODE2 WILL BE LISTED
        const contacts5 = yield http.get(node1.external_ip + '/contacts', (0, helpers_1.makeArgs)(node1));
        ...
        const change2 = yield (0, save_1.updateProfile)(t, node1, meetPrice2);
        t.true(change2, 'node1 should have changed its price to meet');
        //NODE1 CHECK CONTACT INFO
        const self2 = yield (0, get_1.getSelf)(t, node1);
